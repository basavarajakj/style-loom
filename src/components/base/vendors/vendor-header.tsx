...
export default function VendorHeader({
  ...
  return (
    <header
      className={cn(
        'sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background px-4 md:px-6 rounded-t-xl',
        className
      )}
    >
      <SidebarTrigger />
      <div className='flex items-center flex-1 gap-4'>
        <h1 className='font-semibold hidden md:flex text-lg md:text-xl'>
          {title}
        </h1>
